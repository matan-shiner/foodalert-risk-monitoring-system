...
_PRODUCT_CATEGORY_KW: dict[str, list[str]] = {
    "seafood and fish products": [
        ...
        "かまぼこ", "明太子", "たらこ", "海苔", "ホタテ", "牡蠣", "あさり",
        "イワシ", "アジ", "ブリ", "カツオ", "昆布", "わかめ", "干物", "刺身",
        "寿司", "ししゃも", "ホッケ", "しじみ", "ウニ",
    ],
    "meat and poultry products": [
        "牛肉", "豚肉", "鶏肉", "とり肉", "肉", "ハム", "ソーセージ", "ベーコン",
        "焼肉", "鴨肉", "羊肉", "ミンチ", "から揚げ", "つくね", "豚バラ",
        "牛タン", "レバー", "ローストビーフ", "ジビエ",
    ],
    "dairy and eggs": [
        "牛乳", "乳製品", "チーズ", "ヨーグルト", "卵", "たまご", "バター",
        "生クリーム", "アイスクリーム", "プリン", "練乳",
    ],
    "fruits and vegetables": [
        "野菜", "果物", "フルーツ", "りんご", "みかん", "いちご", "トマト",
        "きゅうり", "たまねぎ", "玉ねぎ", "バナナ", "ぶどう", "もも", "なし",
        "メロン", "すいか", "キウイ", "レモン", "じゃがいも", "にんじん",
        "だいこん", "キャベツ", "ほうれん草", "なす", "かぼちゃ", "ねぎ",
        "にんにく", "しょうが", "もやし", "豆腐", "枝豆", "とうもろこし",
    ],
    "cereals and bakery products": [
        "パン", "米", "麺", "めん", "小麦", "ケーキ", "クッキー", "うどん",
        "そば", "ラーメン", "パスタ", "おにぎり", "もち", "まんじゅう",
        "どら焼き", "食パン", "クラッカー", "餃子", "シリアル",
    ],
    "confectionery and snacks": [
        "菓子", "チョコレート", "キャンディ", "スナック", "アイス", "せんべい",
        "ポテトチップス", "ガム", "ゼリー", "飴", "ラムネ", "ようかん",
        "グミ", "マシュマロ",
    ],
    "beverages": [
        "飲料", "ジュース", "お茶", "コーヒー", "酒", "ビール", "ワイン",
        "日本酒", "焼酎", "炭酸飲料", "烏龍茶", "紅茶", "緑茶",
        "ミネラルウォーター", "豆乳",
    ],
    "sauces, condiments and seasonings": [
        "調味料", "ソース", "醤油", "味噌", "ドレッシング", "たれ",
        "みりん", "だし", "ポン酢", "マヨネーズ", "ケチャップ", "わさび",
        "からし",
    ],
    "herbs and spices": [
        "香辛料", "スパイス", "唐辛子", "こしょう", "シナモン", "ターメリック",
    ],
    "dietary supplements": [
        "サプリメント", "健康食品", "ビタミン", "プロテイン", "乳酸菌",
        "コラーゲン",
    ],
    "nuts, seeds and grains": [
        "ナッツ", "種子", "ごま", "大豆", "ピーナッツ", "アーモンド", "くるみ",
        "小豆",
    ],
    "oils and fats": ["油", "オリーブオイル", "サラダ油", "ごま油", "ラード"],
    "prepared dishes and meals": [
        "惣菜", "弁当", "冷凍食品", "レトルト", "カレー", "スープ", "サラダ", "丼",
    ],
}
