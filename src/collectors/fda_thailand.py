...
_PRODUCT_CATEGORY_KW: dict[str, list[str]] = {
    "seafood and fish products": [
        "ปลา", "กุ้ง", "ปู", "หอย", "อาหารทะเล", "ปลาหมึก", "ปลาแซลมอน",
        "ปลาทูน่า", "หอยนางรม", "กั้ง", "สาหร่าย", "ปลาเค็ม", "ลูกชิ้นปลา",
    ],
    "meat and poultry products": [
        "เนื้อหมู", "เนื้อวัว", "ไก่", "เนื้อสัตว์", "ไส้กรอก", "แฮม",
        "เป็ด", "เนื้อแกะ", "หมูยอ", "ลูกชิ้น", "หมูแดดเดียว", "ไก่ทอด",
    ],
    "dairy and eggs": [
        "นม", "ผลิตภัณฑ์นม", "ไข่", "เนย", "ชีส", "โยเกิร์ต", "ครีม",
        "ไอศกรีม", "นมข้นหวาน",
    ],
    "fruits and vegetables": [
        "ผัก", "ผลไม้", "มะเขือเทศ", "แตงกวา", "กล้วย", "มะม่วง", "ส้ม",
        "องุ่น", "แตงโม", "สับปะรด", "มะละกอ", "ทุเรียน", "ลิ้นจี่",
        "มะนาว", "หัวหอม", "กระเทียม", "แครอท", "กะหล่ำปลี", "ผักกาด",
        "พริก", "มันฝรั่ง", "ขิง", "เต้าหู้", "ข้าวโพด",
    ],
    "cereals and bakery products": [
        "ขนมปัง", "ข้าว", "เส้นก๋วยเตี๋ยว", "แป้ง", "บะหมี่", "ข้าวเหนียว",
        "เส้นหมี่", "เค้ก", "คุกกี้", "แครกเกอร์",
    ],
    "confectionery and snacks": [
        "ขนมหวาน", "ช็อกโกแลต", "ลูกอม", "ขนมขบเคี้ยว", "มันฝรั่งทอด",
        "หมากฝรั่ง", "เยลลี่",
    ],
    "beverages": [
        "เครื่องดื่ม", "น้ำผลไม้", "ชา", "กาแฟ", "สุรา", "เบียร์", "ไวน์",
        "น้ำอัดลม", "นมถั่วเหลือง", "น้ำดื่ม", "ชานม",
    ],
    "sauces, condiments and seasonings": [
        "เครื่องปรุง", "ซอส", "น้ำปลา", "ซีอิ๊ว", "น้ำจิ้ม", "น้ำพริก",
        "ซอสมะเขือเทศ", "กะปิ",
    ],
    "herbs and spices": ["พริกไทย", "ขมิ้น", "ยี่หร่า", "อบเชย"],
    "dietary supplements": [
        "ผลิตภัณฑ์เสริมอาหาร", "อาหารเสริม", "วิตามิน", "โปรตีน",
        "คอลลาเจน", "โปรไบโอติก",
    ],
    "nuts, seeds and grains": [
        "ถั่ว", "เมล็ดพันธุ์", "ถั่วลิสง", "อัลมอนด์", "เม็ดมะม่วงหิมพานต์", "งา",
    ],
    "oils and fats": ["น้ำมัน", "น้ำมันพืช", "น้ำมันปาล์ม", "น้ำมันมะกอก"],
    "prepared dishes and meals": [
        "อาหารสำเร็จรูป", "อาหารแช่แข็ง", "ข้าวกล่อง", "สลัด", "ซุป", "แกง",
    ],
}
