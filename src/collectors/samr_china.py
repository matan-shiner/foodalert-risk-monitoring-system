...
_PRODUCT_CATEGORY_KW: dict[str, list[str]] = {
    "seafood and fish products": [
        "鱼", "虾", "蟹", "贝", "海产品", "海鲜", "鱿鱼", "带鱼", "三文鱼",
        "金枪鱼", "牡蛎", "扇贝", "海带", "紫菜", "鲍鱼", "龙虾", "蛤蜊",
        "鱼片", "鱼丸", "鱼干", "虾仁", "螃蟹", "海参",
    ],
    "meat and poultry products": [
        "猪肉", "牛肉", "鸡肉", "肉制品", "火腿", "香肠", "腊肉", "肉",
        "鸭肉", "羊肉", "牛排", "培根", "肉丸", "肉干", "卤肉", "烤肉",
        "鸡爪", "猪蹄", "牛杂",
    ],
    "dairy and eggs": [
        "牛奶", "乳制品", "奶粉", "酸奶", "奶酪", "鸡蛋", "蛋制品", "奶油",
        "黄油", "芝士", "鹌鹑蛋", "皮蛋", "咸蛋", "炼乳",
    ],
    "fruits and vegetables": [
        "蔬菜", "水果", "黄瓜", "苹果", "番茄", "白菜", "菌菇", "食用菌",
        "香蕉", "橙子", "葡萄", "西瓜", "草莓", "梨", "桃", "柠檬", "菠萝",
        "椰子", "榴莲", "荔枝", "木瓜", "猕猴桃", "李子", "樱桃", "土豆",
        "马铃薯", "洋葱", "大蒜", "胡萝卜", "生菜", "菠菜", "辣椒", "茄子",
        "南瓜", "萝卜", "姜", "芹菜", "豆芽", "豆腐", "玉米",
    ],
    "cereals and bakery products": [
        "面包", "糕点", "面条", "大米", "面粉", "馒头", "饼干", "米饭",
        "粉丝", "年糕", "包子", "饺子", "烧饼", "煎饼", "蛋糕", "粽子",
    ],
    "confectionery and snacks": [
        "糖果", "巧克力", "膨化食品", "休闲食品", "蜜饯", "凉果", "月饼",
        "果冻", "薯片", "爆米花", "棒棒糖", "口香糖", "曲奇", "雪糕", "布丁",
    ],
    "beverages": [
        "饮料", "果汁", "茶叶", "咖啡", "酒", "白酒", "啤酒", "葡萄酒",
        "奶茶", "豆浆", "矿泉水", "碳酸饮料", "红酒", "米酒", "果酒",
        "乳酸菌饮料", "茶饮料",
    ],
    "sauces, condiments and seasonings": [
        "调味品", "酱油", "食醋", "酱料", "调味料", "腐乳", "辣酱", "豆瓣酱",
        "沙茶酱", "蚝油", "味精", "鸡精", "芝麻酱", "番茄酱",
    ],
    "herbs and spices": ["香辛料", "白芷", "花椒", "八角", "桂皮", "丁香", "孜然", "胡椒", "辣椒粉", "姜黄"],
    "dietary supplements": [
        "保健食品", "膳食补充剂", "维生素", "益生菌", "蛋白粉", "胶原蛋白",
        "鱼油", "钙片", "保健品",
    ],
    "nuts, seeds and grains": [
        "坚果", "炒货", "种子", "食用油料", "花生", "核桃", "杏仁", "腰果",
        "开心果", "芝麻", "瓜子", "大豆", "黄豆", "红豆", "绿豆",
    ],
    "oils and fats": ["食用油", "食用植物油", "花生油", "橄榄油", "菜籽油", "猪油", "色拉油"],
    "prepared dishes and meals": [
        "熟食", "方便食品", "速冻食品", "预制菜", "盒饭", "外卖", "便当",
        "汤", "沙拉", "罐头", "卤味",
    ],
}
